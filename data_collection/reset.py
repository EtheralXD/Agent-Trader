...
model_path = r'C:\code_projects\algorithms\TINA\model.npz'
...
def run_reset():
    statments = [s.strip() for s in sql_script.split(";") if s.strip()]
...
print('Data was reset and new data was added')
